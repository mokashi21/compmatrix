  ...
  return (
    <>
              ...
              <div class="carousel-inner ">
                <div class="carousel-item active">
                  <img
                    ...
                    alt="..."
                  />
                  <div className="carousel-caption d-md-block caption-center ">
                    <div className="d-flex justify-content-center align-items-center officeData">
                      <p className=" pe-3 captionText">5 Beds</p>
                      <p className=" pe-3 captionText ">2 Baths</p>
                      <p className=" captionText">180 sqft</p>
                    </div>

                    <p className=" captionSubText fs-1">
                ...
                <nav className="navbar navbar-expand-lg navbar-light bg-transparent pt-3 ">
                  <div className="container-fluid">
                    <a className="navbar-brand ml-5  ms-lg-5 " href="/">
                    ...
                    <div
                      className="collapse navbar-collapse col-md-5 col-lg-5   col-xl-5   offset-2"
              ...
              <div className="row">
                <div className="col-lg-10 offset-lg-2">
                  <form className="bg-black d-flex justify-content-between  rounded-4 pb-1 pt-1 formed">
                    <div className="p-1 flex-grow-1 ms-lg-3">
                      <label>Keyword</label>
                      <br />
                      <input
                        type="text"
                    ...
                    />
                    <div className="d-flex align-items-center pe-lg-5 ms-lg-2 buttonses ">
                      <button
      ...
      <div className="container mt-5 pt-5">
        ...
        <div className="d-flex   mt-5 pt-5 gap-5 cardes">
      ...
      <div className="container mt-5 pt-5 pb-5 ">
        <div className="col-12">
          ...
          <div className="pt-5 text-center  working">
            <div>
              <img
                src={icon}
                alt=""
      ...
      <div className="container mt-5 pt-5 pb-5  mb-5  ">
        <div className="col-12">
          ...
          >
            <div className="d-flex justify-content-around pt-3 signings p-5 ">
              ...
              <div>
                <button type="button" class="btn btn-color2 buttonview">
      ...
      >
        <div className="col-6 text-center">
          <h2
            className="text-light headDiscover"
            style={{ fontSize: 60, fontWeight: 500 }}
          >
            Discover a place you'll love to live
          </h2>
          <p
            className="text-light headDiscover2"
      ...
      <div className="container mt-5 pt-5">
        <div className="row">
          ...
          <div className="col-md-6 d-flex justify-content-center discoverImage">
            <img
              src={subHome}
              alt=""
      ...
      <div className="bg-black mt-5 pt-5 pb-5">
        <div className="container p-5 d-flex customers">
          <div className="col-6 fisrtCusto">
            <div>
              <h6
          ...
          <div className="col-6 secondCusto">
            <div>
              <img
                style={{
                  width: 50,
        ...
        <div className="container p-2 pb-5 ">
          ...
          <div className="d-flex  pt-5 companybrands ">
            <div>
              <img src={brand1} alt="" />
            </div>
            <div>
